...
| :-- | :-- | :-- | :-- |
| 1 | Bestellvorgang UI | Der Prozess ist effektiv und schnell und ganz | Darauf aufbauend musste ich lernen Informationen innerhalb der Datenbank abzuändern |
...
| 3 | Landing Page UI | Weil es schlicht geblieben ist | / |
