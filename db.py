...
def insert_sample():
    ...
    user1 = User(email='max.mustermann@example.com', password_hash=generate_password_hash('test1234'), username='max123', first_name='Max', last_name='Mustermann', bio='Hey, my name is Max and I study Business Information Systems!', is_cook=True, phone_number='+49123456789')
    user1.dorm = dorm1
    ...
    db.session.add_all([dorm1, user1, tag1, tag2, lang1, lang2])
    db.session.commit()
